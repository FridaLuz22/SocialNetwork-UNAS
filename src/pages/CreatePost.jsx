  ...
  return (
    <div style={containerStyle} className="flex justify-center items-center">
      <div className="border border-gray-300 p-4 rounded w-full max-w-screen-md">
          ...
          <header className="flex items-center justify-between">
            <div className="flex items-center">
              <button className="flex items-center text-black">
                <img
                  src="../assets/icons/FlechaIzquierda.png"  // Ruta de la imagen de tu botón
                  alt="Botón de Imagen"
        ...
        <div className="border-b border-gray-300 mb-4 pb-4">
          <textarea
            className="w-full border text-black bg-stone-200 border-gray-300 p-2 h-59" // Cambia la clase aquí
